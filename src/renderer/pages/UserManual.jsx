...
const userManualData = [
  ...
  { 
    ...
    a: "大概是您目前鼠标在其他的窗口操作，躲躲猫的层级被其他的窗口遮住，或者按到了`ESC`。按`ALT+F`或者`Ctrl+E`恢复就好。",
    img: ""
  },
  { 
  ...
  { 
    q: "软件支持哪些操作系统？", 
    a: "该软件支持 Windows、macOS操作系统（v2.0.0以往的版本支持）。",
    img: ""
  },
  { 
    q: "如何反馈建议或报告问题？", 
    a: "你可以加入QQ群：834582563 直接@群主提出问题或建议。或者发送邮件至1378813463@qq.com。",
    img: ""
  },
  // { 
  //   q: "如何查看版本信息？", 
  ...
  { 
    q: "关于暂停Mac版本发布", 
    a: "由于MacOs用户较少，且打包流程较为复杂，因此暂时停止发布Mac版本。后续会根据用户需求和开发资源情况决定是否恢复",
    img: ""
  },
];
